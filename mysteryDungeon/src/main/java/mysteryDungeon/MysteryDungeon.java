...
public class MysteryDungeon implements
    ...
    public MysteryDungeon() {
        ...
        BaseMod.addColor(Pokemon.Enums.TORCHIC_RED, Color.RED.cpy(), Color.RED.cpy(), Color.RED.cpy(),
                Color.RED.cpy(), Color.RED.cpy(), Color.RED.cpy(), Color.RED.cpy(),
                ATTACK_DEFAULT_GRAY, SKILL_DEFAULT_GRAY, POWER_DEFAULT_GRAY, ENERGY_ORB_DEFAULT_GRAY,
                ATTACK_DEFAULT_GRAY_PORTRAIT, SKILL_DEFAULT_GRAY_PORTRAIT, POWER_DEFAULT_GRAY_PORTRAIT,
                ENERGY_ORB_DEFAULT_GRAY_PORTRAIT, CARD_ENERGY_ORB);
        ...
        mysteryDungeonDefaultSettings.setProperty(SEND_RUN_DATA, "FALSE"); // This is the default setting. It's actually
                                                                           // set...
        try {
            SpireConfig config = new SpireConfig("mysteryDungeon", "mysteryDungeonConfig",
                    mysteryDungeonDefaultSettings); // ...right here
    ...
    public void receivePostInitialize() {
        ...
        ModLabeledToggleButton enableNormalsButton = new ModLabeledToggleButton(
                "Check this to send data on your runs to the developpers of the mod.",
        ...
        BaseMod.addSaveField("adventurerAndPartner",
                (CustomSavable<ToSave>) new Pokemon("the Pokémon", Pokemon.Enums.THE_POKEMON));
        ...
        new AutoAdd("MysteryDungeon")
                ...
                .any(AbstractPotion.class, (info, potion) -> {
                    BaseMod.addPotion(potion.getClass(), potion.liquidColor, potion.hybridColor, potion.spotsColor,
                            potion.ID, Pokemon.Enums.THE_POKEMON);
                });
    ...
    public void receiveEditRelics() {
        ...
        // This adds every relic in NatureRelatedRelic's folder of the Pokémon's pool
        // and mark those as seen.
        new AutoAdd("MysteryDungeon")
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("MysteryDungeon")
                ...
                .cards();
        new AutoAdd("MysteryDungeon")
                .packageFilter(TorchicScratch.class)
                .setDefaultSeen(true)
                .cards();
        new AutoAdd("MysteryDungeon")
    ...
    public void receiveEditStrings() {
        ...
        BaseMod.loadCustomStringsFile(CharacterStrings.class,
                localizationPath + "MysteryDungeon-Character-Strings.json");
    ...
    public void receiveEditKeywords() {
        ...
        Gson gson = new Gson();
        String json = Gdx.files.internal(LocalizationTool.LocalizationPath() + "MysteryDungeon-Keyword-Strings.json")
