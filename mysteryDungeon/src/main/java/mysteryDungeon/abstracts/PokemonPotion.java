...
public abstract class PokemonPotion extends CustomPotion {
    ...
    public PokemonPotion(String name, String potionId, PotionRarity rarity, String image) {
        ...
        ReflectionHacks.setPrivate(this, AbstractPotion.class, "containerImg",
                TextureLoader.getTexture(MysteryDungeon.makePotionPath(image)));
        ReflectionHacks.setPrivate(this, AbstractPotion.class, "outlineImg",
                TextureLoader.getTexture(MysteryDungeon.makePotionOutlinePath(image)));
