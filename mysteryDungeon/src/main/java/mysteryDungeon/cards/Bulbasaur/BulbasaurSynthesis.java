...
public class BulbasaurSynthesis extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(BulbasaurSynthesis.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(BulbasaurSynthesis.class.getSimpleName()+".png");
