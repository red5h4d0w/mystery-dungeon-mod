...
public class CharmanderDragonDance extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(CharmanderDragonDance.class);
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(CharmanderDragonDance.class);
