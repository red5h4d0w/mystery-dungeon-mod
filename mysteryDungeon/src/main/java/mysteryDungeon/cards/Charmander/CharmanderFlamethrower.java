...
public class CharmanderFlamethrower extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(CharmanderFlamethrower.class);
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(CharmanderFlamethrower.class);
