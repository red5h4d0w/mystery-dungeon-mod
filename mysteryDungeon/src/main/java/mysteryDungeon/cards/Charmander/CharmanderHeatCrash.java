...
public class CharmanderHeatCrash extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(CharmanderHeatCrash.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(CharmanderHeatCrash.class.getSimpleName()+".png");
