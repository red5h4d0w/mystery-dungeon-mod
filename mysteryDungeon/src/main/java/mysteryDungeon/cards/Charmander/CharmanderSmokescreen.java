...
public class CharmanderSmokescreen extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(CharmanderSmokescreen.class);
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(CharmanderSmokescreen.class);
