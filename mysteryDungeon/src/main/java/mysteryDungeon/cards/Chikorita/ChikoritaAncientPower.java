...
public class ChikoritaAncientPower extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(ChikoritaAncientPower.class);
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(ChikoritaAncientPower.class);
