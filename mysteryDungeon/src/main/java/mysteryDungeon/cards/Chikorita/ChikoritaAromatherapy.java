...
public class ChikoritaAromatherapy extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(ChikoritaAromatherapy.class);
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(ChikoritaAromatherapy.class);
