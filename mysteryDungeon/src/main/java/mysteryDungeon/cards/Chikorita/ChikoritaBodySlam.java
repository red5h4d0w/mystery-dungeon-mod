...
public class ChikoritaBodySlam extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(ChikoritaBodySlam.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(ChikoritaBodySlam.class.getSimpleName()+".png");
