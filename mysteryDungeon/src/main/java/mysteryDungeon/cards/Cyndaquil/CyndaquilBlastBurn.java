...
public class CyndaquilBlastBurn extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(CyndaquilBlastBurn.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(CyndaquilBlastBurn.class.getSimpleName()+".png");
