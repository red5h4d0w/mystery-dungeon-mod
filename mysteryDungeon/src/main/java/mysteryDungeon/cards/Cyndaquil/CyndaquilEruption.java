...
public class CyndaquilEruption extends PokemonCard {

    // TEXT DECLARATION

    public static final String ID = MysteryDungeon.makeID(CyndaquilEruption.class);
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(CyndaquilEruption.class);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        addToBot(new EruptionAction(m, true));
