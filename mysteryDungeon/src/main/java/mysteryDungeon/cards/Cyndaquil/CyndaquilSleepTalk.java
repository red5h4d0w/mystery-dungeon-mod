...
import mysteryDungeon.powers.SleepTalkCyndaquilPower;

public class CyndaquilSleepTalk extends PokemonCard {

    // TEXT DECLARATION

    public static final String ID = MysteryDungeon.makeID(CyndaquilSleepTalk.class);
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(CyndaquilSleepTalk.class);
