...
public class MeowthCaptivate extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(MeowthCaptivate.class);
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(MeowthCaptivate.class);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(m, p, new StrengthPower(m, -this.secondMagicNumber), -this.secondMagicNumber));
        if (m != null && !m.hasPower(ArtifactPower.POWER_ID))
            addToBot(new ApplyPowerAction(m, p, new GainStrengthPower(m, this.secondMagicNumber), this.secondMagicNumber)); 
