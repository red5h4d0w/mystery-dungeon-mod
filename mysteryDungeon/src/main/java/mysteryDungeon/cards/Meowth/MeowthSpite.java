...
public class MeowthSpite extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(MeowthSpite.class);
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(MeowthSpite.class);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        if(magicNumber*energyOnUse!=0) {
            ...
            addToBot(new ApplyPowerAction(p, p, new StrengthPower(p, 2*energyOnUse), 2*energyOnUse));
        }
        if (!freeToPlayOnce) {
