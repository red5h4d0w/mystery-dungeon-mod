...
public class PikachuElectricTerrain extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(PikachuElectricTerrain.class);
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(PikachuElectricTerrain.class);
