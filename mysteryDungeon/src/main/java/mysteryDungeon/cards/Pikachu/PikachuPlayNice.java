...
public class PikachuPlayNice extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(PikachuPlayNice.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(PikachuPlayNice.class.getSimpleName()+".png");
