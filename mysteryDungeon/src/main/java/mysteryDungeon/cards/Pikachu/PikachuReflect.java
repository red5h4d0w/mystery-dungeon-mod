...
public class PikachuReflect extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(PikachuReflect.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(PikachuReflect.class.getSimpleName()+".png");
