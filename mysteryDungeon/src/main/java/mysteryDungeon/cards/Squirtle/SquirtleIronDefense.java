...
public class SquirtleIronDefense extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(SquirtleIronDefense.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(SquirtleIronDefense.class.getSimpleName()+".png");
