...
public class SquirtleLiquidation extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(SquirtleLiquidation.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(SquirtleLiquidation.class.getSimpleName()+".png");
