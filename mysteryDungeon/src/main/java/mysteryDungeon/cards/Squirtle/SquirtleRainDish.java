...
public class SquirtleRainDish extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(SquirtleRainDish.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(SquirtleRainDish.class.getSimpleName()+".png");
