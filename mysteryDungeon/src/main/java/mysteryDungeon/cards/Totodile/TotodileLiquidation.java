...
public class TotodileLiquidation extends PokemonCard {

    // TEXT DECLARATION

    public static final String ID = MysteryDungeon.makeID(TotodileLiquidation.class.getSimpleName());
