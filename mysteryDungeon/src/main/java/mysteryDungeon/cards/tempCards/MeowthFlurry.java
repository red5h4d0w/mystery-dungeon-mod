...
public class MeowthFlurry extends PokemonCard {
    ...
    public static final String ID = MysteryDungeon.makeID(MeowthFlurry.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    public static final String IMG = makeCardPath(MeowthFlurry.class.getSimpleName()+".png");
