package mysteryDungeon.events;

import static mysteryDungeon.MysteryDungeon.makeEventPath;
...
public class IdentityCrisisEvent extends AbstractImageEvent {
    ...
    public static final String ID = MysteryDungeon.makeID("IdentityCrisisEvent");
