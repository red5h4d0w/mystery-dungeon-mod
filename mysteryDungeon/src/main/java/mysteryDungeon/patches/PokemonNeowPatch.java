...
public class PokemonNeowPatch {
    ...
    public static void InitializeQuestions() {
        questions.clear();
        String json = Gdx.files.internal(LocalizationTool.LocalizationPath() + "Questions.json")
                .readString(String.valueOf(StandardCharsets.UTF_8));
        ArrayList<Question> fullListOfQuestions = new Gson().fromJson(json, new TypeToken<ArrayList<Question>>() {
        }.getType());
    ...
    public static void talk(String msg) {
        AbstractDungeon.effectList.add(new InfiniteSpeechBubble(1100.0F * Settings.xScale,
                AbstractDungeon.floorY + 60.0F * Settings.yScale, msg));
    }
    ...
    public static void DeterminePokemon(int buttonPressed) {
        ...
        String nature = bestCorrespondingTraits
                .get(AbstractDungeon.eventRng.random(bestCorrespondingTraits.size() - 1));
    ...
    public static Map<String, String[]> NatureOfPokemon = new HashMap<String, String[]>() {
        {
            ...
            put("Torchic", new String[] { "Hasty", "Sassy"});
        }
    };
