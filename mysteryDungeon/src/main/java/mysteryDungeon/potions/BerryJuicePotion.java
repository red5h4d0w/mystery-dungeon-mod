...
public class BerryJuicePotion extends PokemonPotion {

    public static final String POTION_ID = mysteryDungeon.MysteryDungeon.makeID(BerryJuicePotion.class);
