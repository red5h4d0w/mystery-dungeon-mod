...
public class MagoBerryPotion extends PokemonPotion {
    ...
    public static final String POTION_ID = mysteryDungeon.MysteryDungeon.makeID(MagoBerryPotion.class);
    private static final PotionStrings potionStrings = CardCrawlGame.languagePack.getPotionString(POTION_ID);

    public static final String NAME = potionStrings.NAME;
    public static final String[] DESCRIPTIONS = potionStrings.DESCRIPTIONS;

    public static final String IMG_STRING = "mago-berry.png";

    public MagoBerryPotion() {
    ...
    public void use(AbstractCreature target) {
        ...
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player,
                new PoisonPower(AbstractDungeon.player, AbstractDungeon.player, potency / 5), potency / 5));
    }

    @Override
    public AbstractPotion makeCopy() {
        return new MagoBerryPotion();
    }
