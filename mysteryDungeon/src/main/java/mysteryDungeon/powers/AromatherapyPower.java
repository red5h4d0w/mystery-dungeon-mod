...
public class AromatherapyPower extends PokemonPower implements CloneablePowerInterface, OnLoseTempHpPower  {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(AromatherapyPower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(AromatherapyPower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(AromatherapyPower.class.getSimpleName()+"32.png"));
