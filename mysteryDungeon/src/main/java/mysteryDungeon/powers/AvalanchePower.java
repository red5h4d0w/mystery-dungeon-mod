...
public class AvalanchePower extends PokemonPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(AvalanchePower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(AvalanchePower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(AvalanchePower.class.getSimpleName()+"32.png"));
