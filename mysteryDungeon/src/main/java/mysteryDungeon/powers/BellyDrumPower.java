...
public class BellyDrumPower extends PokemonPower implements CloneablePowerInterface, FreeToPlayInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(BellyDrumPower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(BellyDrumPower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(BellyDrumPower.class.getSimpleName()+"32.png"));
