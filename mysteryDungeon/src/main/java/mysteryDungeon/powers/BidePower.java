...
public class BidePower extends PokemonPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(BidePower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(BidePower.class)+"84.png");
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(BidePower.class)+"32.png");
