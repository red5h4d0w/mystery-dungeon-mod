...
public class BurnPower extends PokemonPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = MysteryDungeon.makeID(BurnPower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(BurnPower.class)+"84.png");
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(BurnPower.class)+"32.png");
