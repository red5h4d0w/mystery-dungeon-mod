...
public class ChikoritaExplorerPower extends PokemonPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(ChikoritaExplorerPower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(ChikoritaExplorerPower.class)+"84.png");
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(ChikoritaExplorerPower.class)+"32.png");
