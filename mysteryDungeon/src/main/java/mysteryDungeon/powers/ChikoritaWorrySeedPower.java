...
public class ChikoritaWorrySeedPower extends PokemonPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader
            .getTexture(makePowerPath(ChikoritaWorrySeedPower.class.getSimpleName() + "84.png"));
    private static final Texture tex32 = TextureLoader
            .getTexture(makePowerPath(ChikoritaWorrySeedPower.class.getSimpleName() + "32.png"));
    ...
    public void atEndOfTurn(boolean isPlayer) {
        if (isPlayer)
            addToBot(new HealAction(AbstractDungeon.player, AbstractDungeon.player, 3 * amount));
