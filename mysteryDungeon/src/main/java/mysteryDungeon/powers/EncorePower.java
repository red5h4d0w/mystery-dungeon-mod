...
public class EncorePower extends MysteryDungeonPower implements CloneablePowerInterface, onDyingInterface {
    ...
    public void onUseCard(AbstractCard card, UseCardAction action) {
        if (!card.purgeOnUse && card.type == AbstractCard.CardType.ATTACK && this.amount > 0) {
            ...
            this.amount--;
            if (this.amount == 0)
            addToBot((AbstractGameAction)new RemoveSpecificPowerAction(this.owner, this.owner, "Encore"));
        }
        if (!card.purgeOnUse && card.type == AbstractCard.CardType.SKILL && this.amount > 0) {
            ...
            this.amount--;
            if (this.amount == 0)
              addToTop((AbstractGameAction)new RemoveSpecificPowerAction(this.owner, this.owner, "Encore")); 
          }  
    }
