...
public class EndurePower extends PokemonPower implements CloneablePowerInterface, onDyingInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(EndurePower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(EndurePower.class+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(EndurePower.class+"32.png"));
