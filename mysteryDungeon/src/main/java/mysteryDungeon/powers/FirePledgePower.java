...
public class FirePledgePower extends PokemonPower implements CloneablePowerInterface, BetterOnApplyPowerPower {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(FirePledgePower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(FirePledgePower.class)+"84.png");
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(FirePledgePower.class)+"32.png");
