...
public class FrustrationPower extends PokemonPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(FrustrationPower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(FrustrationPower.class+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(FrustrationPower.class+"32.png"));
