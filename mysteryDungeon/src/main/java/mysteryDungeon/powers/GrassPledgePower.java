...
public class GrassPledgePower extends PokemonPower implements CloneablePowerInterface, BetterOnApplyPowerPower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(GrassPledgePower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(GrassPledgePower.class.getSimpleName()+"32.png"));
