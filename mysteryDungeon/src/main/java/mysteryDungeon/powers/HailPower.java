...
public class HailPower extends PokemonPower implements CloneablePowerInterface, onDrawInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(HailPower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(HailPower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(HailPower.class.getSimpleName()+"32.png"));
