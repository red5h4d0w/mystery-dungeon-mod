...
public class HeatCrashPower extends PokemonPower implements CloneablePowerInterface, OnReceivePowerPower {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(HeatCrashPower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(HeatCrashPower.class+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(HeatCrashPower.class+"32.png"));
