...
public class LeechSeedPower extends PokemonPower implements CloneablePowerInterface, HealthBarRenderPower {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(LeechSeedPower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(LeechSeedPower.class)+"84.png");
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(LeechSeedPower.class)+"32.png");
