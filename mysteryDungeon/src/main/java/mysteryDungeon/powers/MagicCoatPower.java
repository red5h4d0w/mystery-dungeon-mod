...
public class MagicCoatPower extends PokemonPower implements CloneablePowerInterface, OnLoseTempHpPower {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(MagicCoatPower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(MagicCoatPower.class+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(MagicCoatPower.class+"32.png"));
