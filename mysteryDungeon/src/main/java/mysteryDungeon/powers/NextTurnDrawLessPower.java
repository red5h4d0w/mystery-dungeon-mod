...
public class NextTurnDrawLessPower extends MysteryDungeonPower implements CloneablePowerInterface, OnReceivePowerPower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(NextTurnDrawLessPower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(NextTurnDrawLessPower.class.getSimpleName()+"32.png"));
