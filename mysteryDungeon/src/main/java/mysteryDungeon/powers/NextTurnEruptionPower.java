...
public class NextTurnEruptionPower extends PokemonPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(NextTurnEruptionPower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(NextTurnEruptionPower.class+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(NextTurnEruptionPower.class+"32.png"));
