...
public class PetalDancePower extends PokemonPower implements CloneablePowerInterface, OnReceivePowerPower {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(PetalDancePower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(PetalDancePower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(PetalDancePower.class.getSimpleName()+"32.png"));
