...
public class PsychUpPower extends PokemonPower implements CloneablePowerInterface, BetterOnApplyPowerPower {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(PsychUpPower.class)+"84.png");
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(PsychUpPower.class)+"32.png");
