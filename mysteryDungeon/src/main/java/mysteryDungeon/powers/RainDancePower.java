...
public class RainDancePower extends PokemonPower implements CloneablePowerInterface, onCreateTempCardInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(RainDancePower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(RainDancePower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(RainDancePower.class.getSimpleName()+"32.png"));
