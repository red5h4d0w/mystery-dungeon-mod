...
public class RainDancePower extends PokemonPower implements CloneablePowerInterface, onCreateTempCardInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(RainDancePower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(RainDancePower.class)+"84.png");
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(RainDancePower.class)+"32.png");
