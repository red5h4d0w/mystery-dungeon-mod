...
public class RainDishPower extends PokemonPower implements CloneablePowerInterface, onCardScriedInterface, onManualDiscardInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(RainDishPower.class.getSimpleName());
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(RainDishPower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(RainDishPower.class.getSimpleName()+"32.png"));
