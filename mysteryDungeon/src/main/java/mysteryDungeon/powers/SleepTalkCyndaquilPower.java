...
public class SleepTalkCyndaquilPower extends PokemonPower implements CloneablePowerInterface, onCreateTempCardInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(SleepTalkCyndaquilPower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(SleepTalkCyndaquilPower.class.getSimpleName()+"32.png"));
