...
public class SurfPower extends PokemonPower implements CloneablePowerInterface, onManualDiscardInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(SurfPower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(SurfPower.class)+"84.png");
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(SurfPower.class)+"32.png");
