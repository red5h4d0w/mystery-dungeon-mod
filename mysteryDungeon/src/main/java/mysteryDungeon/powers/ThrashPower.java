...
public class ThrashPower extends PokemonTwoAmountPower implements CloneablePowerInterface, NonStackablePower {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(ThrashPower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(ThrashPower.class+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(ThrashPower.class+"32.png"));
