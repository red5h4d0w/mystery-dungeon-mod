...
public class TorrentPower extends MysteryDungeonPower implements CloneablePowerInterface, onShufflePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(TorrentPower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(TorrentPower.class.getSimpleName()+"32.png"));
