...
public class TorrentPower extends PokemonPower implements CloneablePowerInterface, onShufflePowerInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(TorrentPower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(TorrentPower.class+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(TorrentPower.class+"32.png"));
