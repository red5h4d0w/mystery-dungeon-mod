...
public class WhirlpoolPower extends PokemonPower implements CloneablePowerInterface {
    ...
    public static final String POWER_ID = MysteryDungeon.makeID(WhirlpoolPower.class);
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(WhirlpoolPower.class+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(WhirlpoolPower.class+"32.png"));
