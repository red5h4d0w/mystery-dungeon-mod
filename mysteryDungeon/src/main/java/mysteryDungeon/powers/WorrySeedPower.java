...
public class WorrySeedPower extends MysteryDungeonPower implements CloneablePowerInterface, onCreateRewards {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(WorrySeedPower.class.getSimpleName()+"84.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(WorrySeedPower.class.getSimpleName()+"32.png"));
