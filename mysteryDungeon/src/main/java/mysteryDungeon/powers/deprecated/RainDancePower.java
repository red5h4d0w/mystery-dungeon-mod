...
public class RainDancePower extends PokemonPower implements CloneablePowerInterface {
    ...
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath(RainDancePower.class));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath(RainDancePower.class));
