...
public class GrassySeedRelic extends PokemonRelic { 
    ...
    private static final Texture IMG = TextureLoader.getTexture(makeRelicPath("grassy-seed.png"));
    private static final Texture OUTLINE = TextureLoader.getTexture(makeRelicOutlinePath("grassy-seed.png"));
