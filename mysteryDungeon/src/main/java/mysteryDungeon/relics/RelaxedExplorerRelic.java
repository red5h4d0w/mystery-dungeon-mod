...
public class RelaxedExplorerRelic extends CustomRelic { // You must implement things you want to use from StSlib
    /*
    ...
    // ID, images, text.
    public static final String ID = MysteryDungeon.makeID("RelaxedExplorerRelic");
