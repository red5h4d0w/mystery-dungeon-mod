...
public class PikachuMeter {
    ...
    public void render(SpriteBatch sb, AbstractPlayer player) {
        if (AbstractDungeon.getCurrMapNode() != null && 
            ...
            sb.draw(ImageMaster.OPTION_SLIDER, x + BOX_W/2 - 22f + counterPosition* 58f, y - h - BOX_BODY_H - METER_HEIGHT/2, 22f, 22.0F, 44.0F, 44.0F, Settings.scale, Settings.scale, 0.0F, 0, 0, 44, 44, false, false);
